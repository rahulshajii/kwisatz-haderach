...
function generateCode(prefix = "KH26") {
  let suffix = "";
  for (let i = 0; i < 5; i++) {
...
async function main() {
  console.log("Seeding KWISATZ HADERACH database for PRAGYAN 2026...");
  ...
  if (!quiz) {
    ...
    console.log(`✓ Quiz already exists: ${quiz.name} (${quiz.id})`);
  }
  ...
  console.log(`✓ Seeded ${SAMPLE_QUESTIONS.length} technical questions.`);
  ...
  console.log(`✓ Seeded ${DEMO_PARTICIPANTS.length} demo participants (including ${DEMO_PARTICIPANTS[0].code} for Rahul Shaji).`);

  console.log("\n=======================================================");
  console.log("KWISATZ HADERACH SEED COMPLETE!");
  console.log(`Admin Login: ${adminUsername} / ${adminPassword}`);
  console.log(`Demo Participant Code: ${DEMO_PARTICIPANTS[0].code} (${DEMO_PARTICIPANTS[0].name})`);
  console.log("=======================================================\n");
}
